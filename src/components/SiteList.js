...
const SiteList = () => {
  ...
  const handleEditSite = (site) => {
    ...
    // Here you can navigate to the Edit Site component or open a modal
  };
  ...
  return (
    <Paper sx={{ p: 3 }}>
      ...
      <SiteDataTable onEditSite={handleEditSite} onCreateQuote={handleCreateQuote} />
      <Drawer
        anchor="right"
        open={drawerOpen}
      ...
      >
        <Box sx={{ width: 450, p: 3 }}>
          ...
          {selectedSite && (
            <GenerateQuote site={selectedSite} />
          )}
        </Box>
      </Drawer>
    </Paper>
