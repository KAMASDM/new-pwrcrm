// src/components/SiteDataTable.js
...
const SiteDataTable = ({ onEditSite, onCreateQuote }) => {
  ...
  const columns = [
    ...
    { field: 'current_gas_and_electricity_supplier_details', headerName: 'Supplier Details', width: 250 },
    ...
    { field: 'isBillingSiteSame', headerName: 'Billing Same as Site', width: 150 },
    { field: 'billingAddressLine1', headerName: 'Billing Address Line 1', width: 200 },
    { field: 'billingAddressLine2', headerName: 'Billing Address Line 2', width: 200 },
    { field: 'billingAddressLine3', headerName: 'Billing Address Line 3', width: 200 },
    { field: 'billingAddressLine4', headerName: 'Billing Address Line 4', width: 200 },
    ...
    { field: 'welcome_letter_send', headerName: 'Welcome Letter Sent', width: 150 },
